defmodule Rumbl.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "with invalid data doesn't insert user" do
    ...
    test "Registration does not accept long username" do
    ...
    test "Registration requires password to be at least 6 characters long" do
  ...
  describe "authenticate_by_username_and_pass/2" do
    ...
    test "returns not found error when invalid username is sent" do
      assert {:error, :not_found} = Accounts.authenticate_by_username_and_pass("unknown", @pass)
    end
